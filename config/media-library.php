...
return [
  ...
  //  'temporary_upload_model' => Spatie\MediaLibraryPro\Models\TemporaryUpload::class,
     ...
     * dependency.
     */
    'ffmpeg_path' => env('FFMPEG_PATH', 'C:\ffmpeg\bin\ffmpeg.exe'), // Update path for Windows
    'ffprobe_path' => env('FFPROBE_PATH', 'C:\ffmpeg\bin\ffprobe.exe'), // Update path for Windows
